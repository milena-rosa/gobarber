...
let SendForgotPasswordEmailService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!user) {
      throw new _AppError.default('This e-mail is not registered.', 400);
    }
    ...
    const forgotPasswordTemplate = _path.default.resolve(__dirname, '..', 'templates', 'forgot_password.hbs');
